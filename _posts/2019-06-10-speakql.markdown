...
This a post regaring our project [SpeakQL](https://adalabucsd.github.io/speakql.html). SpeakQL will appear in the demonstration track at SIGMOD 2019. The paper titled Demonstration of SpeakQL: Speech-driven Multimodal Querying of Structured Data is available [here](https://adalabucsd.github.io/papers/2019_SpeakQL_SIGMOD.pdf). It is co-authored with Side Li, Kevin Yang, Arun Kumar, and Lawrence Saul.


Introduction
============================

Speech recognition engines are becoming really powerful today as we witness a wide spread adoption of speech based inputs. People are speaking and interacting with their smartphones, tablets and even conversational assistants such as Amazon's Alexa, Microsoft’s Cortana, and Apple's Siri.
...
<div align="center" markdown="1">
![SpeakQL Users]({{site.baseurl}}/assets/2019-06-10-speakql/asr_errors.png)
</div>
...
**Literal determination.**  Identifies the literals for the placeholder variables. We create a literal voting algorithm based on our observations about how ASR fails to identify correct literals. <br>
...
<div align="center" markdown="1">
<iframe width="720" height="415" src="https://vimeo.com/295693078"></iframe>
</div>
